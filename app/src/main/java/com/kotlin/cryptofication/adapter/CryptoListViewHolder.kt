...
class CryptoListViewHolder(view: View): RecyclerView.ViewHolder(view) {
    ...
    fun bind(crypto: CryptoModel) {
        ...
        if (crypto.price_change_percentage_24h >= 0) {
            ...
            binding.tvAdapterCryptoTextPriceChange.setTextColor(ContextCompat.getColor(CryptOficatioNApp.appContext(), R.color.green_high))
        } else {
            ...
            binding.tvAdapterCryptoTextPriceChange.setTextColor(ContextCompat.getColor(CryptOficatioNApp.appContext(), R.color.red_low))
        }
    }
}